...
export const UPDATE_PERSONAL_BLOG_REQUEST = "UPDATE_PERSONAL_BLOG_REQUEST";
export const UPDATE_PERSONAL_BLOG_SUCCESS = "UPDATE_PERSONAL_BLOG_SUCCESS";
export const UPDATE_PERSONAL_BLOG_SUCCESS_RESET =
  "UPDATE_PERSONAL_BLOG_SUCCESS_RESET";
export const UPDATE_PERSONAL_BLOG_FAIL = "UPDATE_PERSONAL_BLOG_FAIL";
